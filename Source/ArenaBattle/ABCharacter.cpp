...
void AABCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis(TEXT("Move Forward / Backward"), this, &AABCharacter::UpDown);
	PlayerInputComponent->BindAxis(TEXT("Move Right / Left"), this, &AABCharacter::LeftRight);
...
void AABCharacter::AttackCheck()
{
	...
	if(bResult)
	{
		if(IsValid(HitResult.GetActor()))
		{
			...
			HitResult.GetActor()->TakeDamage(50, DamageEvent, GetController(), this);
		}
	}
}
